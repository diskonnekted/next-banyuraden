    ...
    return (
        <div className="container mx-auto px-4 py-4">
            ...
            <div className="text-center mb-4">
                ...
                <h1 className="text-4xl font-bold text-gray-900 mb-4">Visi dan Misi Kalurahan Banyuraden</h1>
                <p className="text-xl text-gray-600">
                    Arah pembangunan dan tujuan bersama untuk masa depan Kalurahan Banyuraden yang lebih baik
                </p>
            </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-green-50 p-4 rounded-lg">
                                ...
                                <div className="bg-white/70 p-4 rounded-lg">
                                    <p className="text-gray-600 italic text-center">
                                        &quot;Visi Kalurahan Banyuraden akan disusun berdasarkan musyawarah masyarakat
