 ...
 * Handles notifications, alerts, and system messages for Banyuraden Village Portal
 */
...
export class LocalNotificationStorage implements NotificationStorage {
    private storageKey = "banyuraden_notifications";
...
export class NotificationManager {
    ...
    private loadPreferences(): void {
        try {
            const stored = localStorage.getItem("banyuraden_notification_preferences");
            if (stored) {
    ...
    private savePreferences(): void {
        try {
            localStorage.setItem("banyuraden_notification_preferences", JSON.stringify(this.preferences));
        } catch {}
    }
}
