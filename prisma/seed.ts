...
async function main() {
    ...
    await prisma.aparaturPamong.upsert({ where: { id: 1 }, update: {}, create: { id: 1, namaLengkap: "Sudarisman", gelar: "S.T.", jabatan: "LURAH", kelompok: "PEMERINTAH", pendidikan: "Sarjana Teknik", pengalaman: "Periode 2013-2020 dan 2021-2028", urutan: 1, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 2 }, update: {}, create: { id: 2, namaLengkap: "Hendy Indra Utama", gelar: "S.IP", jabatan: "CARIK", kelompok: "PEMERINTAH", pendidikan: "Sarjana Ilmu Pemerintahan", pengalaman: "Sekretariat Kalurahan", urutan: 2, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 3 }, update: {}, create: { id: 3, namaLengkap: "Danarta Yuyun Afnan Anjar Purnomo", gelar: "S.E.", jabatan: "KAUR", kelompok: "PEMERINTAH", pendidikan: "Sarjana Ekonomi", pengalaman: "Bidang Administrasi dan Keuangan", urutan: 3, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 4 }, update: {}, create: { id: 4, namaLengkap: "Pangripto Suryanto", gelar: "S.E.", jabatan: "KAUR", kelompok: "PEMERINTAH", pendidikan: "Sarjana Ekonomi", pengalaman: "Bidang Pembangunan dan Keuangan", urutan: 4, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 5 }, update: {}, create: { id: 5, namaLengkap: "Sidig Wijanarko", gelar: "A.Md", jabatan: "JAGABAYA", kelompok: "PEMERINTAH", pendidikan: "Diploma", pengalaman: "Penjaga dan Pengamanan Kalurahan", urutan: 5, aktif: true } });
    ...
    await prisma.aparaturPamong.upsert({ where: { id: 14 }, update: {}, create: { id: 14, namaLengkap: "Sutarto", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanDowangan.id, urutan: 1, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 15 }, update: {}, create: { id: 15, namaLengkap: "Parjuli", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanKaliabu.id, urutan: 2, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 16 }, update: {}, create: { id: 16, namaLengkap: "Amin Achmadi", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanDukuh.id, urutan: 3, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 17 }, update: {}, create: { id: 17, namaLengkap: "Hadi Istanto", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanSomodaran.id, urutan: 4, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 18 }, update: {}, create: { id: 18, namaLengkap: "Subiyatna", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanSukunan.id, urutan: 5, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 19 }, update: {}, create: { id: 19, namaLengkap: "Jumakir", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanKanoman.id, urutan: 6, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 20 }, update: {}, create: { id: 20, namaLengkap: "Dymas Alfandy Saputra", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanBanyumeneng.id, urutan: 7, aktif: true } });
    await prisma.aparaturPamong.upsert({ where: { id: 21 }, update: {}, create: { id: 21, namaLengkap: "Suhartono", gelar: "", jabatan: "DUKUH", kelompok: "DUKUH", padukuhanId: padukuhanModinan.id, urutan: 8, aktif: true } });
